...
export default function Research() {
  return <>
    <header className="border-b border-[#35515b] bg-[#142832] py-20"><div className="page-wrap"><p className="eyebrow">Research papers / 03</p><h1 className="display mt-4 text-5xl font-extrabold sm:text-7xl">Questions worth measuring.</h1><p className="story-lead mt-6 max-w-3xl text-lg">These papers let me follow a question beyond the first neat answer: design an experiment, work through a model, and occasionally discover that my original idea was wrong. That is where the interesting learning began. You can read the full PDFs below; the chemistry paper is clearly marked as a working draft.</p></div></header>
