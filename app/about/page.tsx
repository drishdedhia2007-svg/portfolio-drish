  ...
  return <>
    ...
    <div className="page-wrap grid gap-12 py-18 lg:grid-cols-[.32fr_.68fr] lg:gap-20 lg:py-24">
      ...
      <div className="space-y-12">
        ...
        <section className="border-t border-[#d9ded8] pt-6"><span className="technical text-[10px] text-[#a74727]">03 / EXPERIENCE</span><h2 className="display mt-3 text-3xl font-extrabold">From a model to a real test</h2><p className="mt-4 text-[1.06rem] leading-8 text-[#42545c]">During a mechanical design internship with STAR Space Technology and Aeronautical Rocketry in Surat, I worked on a static motor test pad using Fusion 360 and Proteus. It was an early lesson in designing around the test itself, rather than only around what looked good on screen. I also completed GE Aerospace’s Explore Engineering online job simulation, where I worked through energy source and engine performance tasks.</p><p className="mt-4 text-[1.06rem] leading-8 text-[#42545c]">At RWTH, I am part of Ecogenium’s chassis department, contributing to a hydrogen fuel cell vehicle for the Shell Eco-marathon. Automotive engineering and renewable energy systems interest me, and I am keeping my direction open while I build wider experience.</p></section>
